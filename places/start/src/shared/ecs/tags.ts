 ...
 */
export function start(world: World, bound: ReadonlyMap<string, ComponentConstructor<object>>): void {
	function spawnBound<T extends object>(instance: Instance, component: ComponentConstructor<T>): void {
